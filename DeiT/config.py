def get_config(variant=None): # deit_tiny and deit_tiny_distilled
    if variant == 'deit_tiny':
        return {
            'MODEL': {
            'NAME': 'deit_tiny',        # Default: None
            'TAG': 'Transformer',       # set to one of those ['CNN', 'MLP', 'TRANSFORMER']
    ...
    elif variant == 'deit_tiny_distilled':
        return {
            'MODEL': {
            'NAME': 'deit_tiny_distilled',        # Default: None
            'TAG': 'Transformer',       # set to one of those ['CNN', 'MLP', 'TRANSFORMER']
            'NUM_CLASSES': 5,           # Default: 5
            'DROP_PATH_RATE': 0.1,      # Default: 0.1
            'LABEL_SMOOTHING': 0.1,     # Default: 0.1
